...
Once again, I got interesting feedback about my presentation, and even had the chance to have [a talk on a side-channel attack](https://ninjalab.io/eucleak/) at the opening of the conference, hence the audience was able to have a panoramic view of the domain. And, at my surprise, I got cited on multiple posts regarding the conference afterward, with some people describing the talk as "intellectually challenging but enriching".
